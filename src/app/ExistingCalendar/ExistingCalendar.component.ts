...
@Component({
  selector: 'app-ExistingCalendar',
  templateUrl: './ExistingCalendar.component.html',
  styleUrls: ['./ExistingCalendar.component.css']
})
export class ExistingCalendarComponent implements OnInit {
  myCalendars:any=[];
